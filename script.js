...
$('.tools_grid').click(function () {
    if (grid) {
        ...
        $('.scene').css('border', '0px solid #d0baef');
        $('.scene_pixelrow').css('box-shadow', '0px 0.3px rgba(255, 255, 255, 0.2) inset, 0px 0px rgba(255, 255, 255, 0.0) inset')
        $('.scene_pixelcolumn').css('box-shadow', '0px 0px rgba(255, 255, 255, 0.0) inset, 0.3px 0px rgba(255, 255, 255, 0.2) inset')
        grid = true;
